...
<div style="height: 20px; margin-top: -20px; background: #27AAE1;"></div>

<div class="container">
    <h1>Add Uniform to Cart</h1>
    <p>Add Item to cart and proceed to buy it.</p>
    <div class="row">
...
//                        $description=substr($description, 0,150).'...';
            ...
            <div class="reo">
            <a href="cart.php"  id=<?php $id ?> ><span class="btn btn-info">
